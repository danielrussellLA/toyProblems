...
Tree.prototype.map = function (callback) {
  ...
  function recurse(originalTree, newTree) {
    newTree.value = callback(originalTree.value);
    if (originalTree.children) {
      for(var i = 0; i < originalTree.children.length; i++){
        var newChild = new Tree();
        newTree.children.push(newChild);
        recurse(originalTree.children[i], newChild);
      }
    }
  }
